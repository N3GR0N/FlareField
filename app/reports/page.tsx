      ...
      <main className="flex min-h-[calc(100vh-3.5rem)] items-center justify-center px-6 pb-20 md:pb-6">
        <div className="bubble-card bubble-enter mx-auto w-full max-w-md text-center">
          <div className="bubble-card-content space-y-6">
            <h1 className="text-title-large" style={{ color: "var(--md-sys-color-on-surface)" }}>
              Mis Reportes
            </h1>
            ...
            <div className="flex items-center justify-center gap-3">
              <div className="h-5 w-5 rounded-full border" style={{ borderColor: "var(--md-sys-color-outline-variant)" }} />
              <div className="h-5 w-5 rounded-full border" style={{ borderColor: "var(--md-sys-color-outline-variant)" }} />
              <div className="h-5 w-5 rounded-full border" style={{ borderColor: "var(--md-sys-color-outline-variant)" }} />
            </div>
            <p className="mx-auto max-w-xs text-body-medium" style={{ color: "var(--md-sys-color-on-surface-variant)" }}>
